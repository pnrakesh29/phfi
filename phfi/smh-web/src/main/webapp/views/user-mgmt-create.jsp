					...
					<div class="main-content-holder">
						<div class="row">
							<div class="col-sm-12">
								...
								<!-- Page Form Start -->
								<form:form action="process-user-mgmt-create" commandName="adminUserRequest">
									<div class="col-sm-12">
										<div class="row">
											<div class="field-element-row">		
											
												<fieldset class="col-sm-4"> 
													<label class="control-label" for="">Role Category<span class="required-field">*</span></label>
													<form:select cssClass="form-control" title="Entity Type" id="userType" path="userType" onblur="validateEntityType()" onchange="fetchRoles()" >
												...
												<fieldset class="col-sm-4"> 
													...
													<form:select cssClass="form-control" title="Role Name" id="userRoleId" path="userRoleId"  onblur="validateRole()" >
															<form:option value="">.:Select:.</form:option>
										...
										<div class="col-sm-12 form-action-buttons">
											...
											<div class="col-sm-7">
												<input type="submit" class="form-control button pull-right" onclick="return validateCreate()" value="Save" >
