				...
				<div class="col-xs-12 content-wrapper">
					...
					<table id="serviceResults" class="table table-striped table-bordered  ">
						<tr>
							...
							<input type="submit" id="buttonCreate" class="button" value="Asha" style="height: 25px" onclick="document.location.href='dashboard-Asha-Next-page';">
							<input type="submit" id="buttonCreate" class="button"  value="Doctor" style="height: 25px;" onclick="document.location.href='dashboard-Doctor-Next-page';">
						</tr>
					</table>
				</div>
			</article>
