				...
				<div class="col-xs-12 content-wrapper">
					...
					<table id="serviceResults" class="table table-striped table-bordered  ">
						<tr>
							...
							<input type="submit" id="buttonCreate" class="button" value="Ratify" style="height: 25px" onclick="return submitData()">
							<input type="submit" id="buttonCreate" class="button"  value="Add Medical Details" style="height: 25px;" onclick="return submitData()">
							<input type="submit" id="buttonCreate" class="button"  value="Back" style="height: 25px;" onclick="document.location.href='dashboard-sec-page';"></p></td></p></td>
						</tr>
					</table>
				</div>
			</article>
