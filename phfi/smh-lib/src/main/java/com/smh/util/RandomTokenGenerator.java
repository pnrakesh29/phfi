...
public class RandomTokenGenerator {
  ...
  public static String[] BIN_PREFIX_LIST = new String[] { "453969" };
  ...
  public static String cardNumber(String prefix, int length) {
    return completedNumber(prefix, length);
  }

  public static String[] cardNumber(String[] prefixList, int length, int howMany) {
  ...
  public static void main(String[] args) {
    String creditcardnumber = cardNumber(BIN_PREFIX_LIST[0], 19);
      System.out.println(creditcardnumber + ":"
                         + (isValidCreditCardNumber(creditcardnumber) ? "valid" : "invalid"));
  }
}