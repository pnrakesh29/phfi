			...
			<article>
				<div class="col-xs-12 content-wrapper">					
					...
					<div class="breadCrumb">
						<span class="breadcrumb-text">Doctor Ratified Report</span>
					...
					<div class="main-content-holder">
						<div class="row">
							<div class="col-sm-12">
								...
								<!-- Page Form Start -->
								<form:form action="get-doctor-ratified-reports" commandName="reportRequest" method="GET">
									<div class="col-sm-12">
										<div class="row">
										...
										<div class="col-sm-12 form-action-buttons">
											...
											<div class="col-sm-7">
												...
												<a href="beacon-mgmt-search" class="form-control button pull-right">Reset</a>
											</div>	
										</div>
									...
									<c:when test="${!(fn:length(masterReportList) eq 0)}">
										<c:forEach items="${masterReportList}" var="womanData">
											<tr>	
												...
												<td data-title="Clinical Assesment Status">${womanData.clinicalStatus}</td>
												<td data-title="Village Name">${womanData.villageName}</td>
											</tr>
										</c:forEach>
									</c:when>
									<c:otherwise>
										 ...
										 <div class="col-sm-4">
											<div class="btn-toolbar" role="toolbar">
												<div class="btn-group custom-table-footer-button">
													<a id="export-to-excel" onclick="$('#serviceResults').tableExport({type:'excel',escape:'false',worksheetName:'Master Ratified Report'});">
